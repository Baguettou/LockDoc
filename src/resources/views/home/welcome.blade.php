...
<div class="row m-6">
    ...
    <div class="col m-4 d-flex flex-column align-items-center justify-content-center">
        <h1 class="text-center">¡Bienvenid@ a LockDoc!</h1>
